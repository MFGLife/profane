...
function init() {
  ...
  loader.load('https://the-profane.com/city.glb', function (gltf) {
  city = gltf.scene;
...
loader.load('https://the-profane.com/anya.glb', function (gltf) {
anya = gltf.scene;
scene.add(anya);
...
loader.load('https://the-profane.com/FelixGLB.glb', function (gltf) {
    felix = gltf.scene;
    scene.add(felix);
...
loader.load('https://the-profane.com/crycella.glb', function (gltf) {
    crycella = gltf.scene;
    scene.add(crycella);
...
loader.load('https://the-profane.com/knife.glb', function (gltf) {
  isKnifeLoaded = true;
knife = gltf.scene;
scene.add(knife);
...
loader.load('https://the-profane.com/potion.glb', function (gltf) {
  potion = gltf.scene;
...
loader.load('https://the-profane.com/altar.glb', function (gltf) {
    altar = gltf.scene;
...
loader.load('https://the-profane.com/gateway.glb', function (gltf) {
gateway = gltf.scene;
...
loader.load('https://the-profane.com/candles.glb', function (gltf) {
    candles = gltf.scene;
...
loader.load('https://the-profane.com/powercaps.glb', function (gltf) {
    let tree = gltf.scene;
...
function addRandomTrees(numberOfTrees) {
    ...
    for (let i = 0; i < numberOfTrees; i++) {
        loader.load('https://the-profane.com/tree.glb', function (gltf) {
            let tree = gltf.scene;
            tree.scale.set(9, 9, 9);
...
loader.load('https://the-profane.com/building1.glb', function (gltf) {
...
loader.load('https://the-profane.com/hobbitmountain.glb', function (gltf) {
