...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function checkPasscode2() {
    ...
    if(code2 === "unhardening") {
      chatWindow2.innerHTML += '<p>Ofmicheal: You have unlocked code 1:dd9</p>';
      scrollToBottom();
    }
    if(code2 === "02/02/2022") {
      chatWindow2.innerHTML += '<p>Ofmicheal: You have unlocked code 2:cd1</p>';
      scrollToBottom();
    }
    if(code2 === "Masonic Temple") {
      chatWindow2.innerHTML += '<p>Ofmicheal: You have unlocked code 3:72s</p>';
      scrollToBottom();
    }
