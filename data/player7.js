...
function checkPasscode2() {
  ...
  if(code2 === "Equisetum") {
    chatWindow2.innerHTML += '<p>Ofmicheal: You have unlocked code 1:qk7</p>';
    scrollToBottom();
  }
  if(code2 === "The Apothecary") {
    chatWindow2.innerHTML += '<p>Ofmicheal: You have unlocked code 2:3gg</p>';
    scrollToBottom();
  }
  if(code2 === "Luminafields") {
    chatWindow2.innerHTML += '<p>Ofmicheal: You have unlocked code 3:i76</p>';
    scrollToBottom();
  }
