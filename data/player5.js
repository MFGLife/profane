...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function checkPasscode2() {
    ...
    if(code2 === "nightshade") {
      chatWindow2.innerHTML += '<p>Ofmicheal: You have unlocked code 1:866</p>';
      scrollToBottom();
    }
    if(code2 === "02/04/1924") {
      chatWindow2.innerHTML += '<p>Ofmicheal: You have unlocked code 2:sx2</p>';
      scrollToBottom();
    }
    if(code2 === "Tom's Town") {
      chatWindow2.innerHTML += '<p>Ofmicheal: You have unlocked code 3:hg7</p>';
      scrollToBottom();
    }
