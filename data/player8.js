...
function checkPasscode2() {
  ...
  if(code2 === "Ghost Orchid") {
    chatWindow2.innerHTML += '<p>Ofmicheal: You have unlocked code 1:00o</p>';
    scrollToBottom();
  }
  if(code2 === "Indigo Wild") {
    chatWindow2.innerHTML += '<p>Ofmicheal: You have unlocked code 2:2ws</p>';
    scrollToBottom();
  }
  if(code2 === "KC Conjure") {
    chatWindow2.innerHTML += '<p>Ofmicheal: You have unlocked code 3:cy4</p>';
    scrollToBottom();
  }
