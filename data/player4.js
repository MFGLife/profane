...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function checkPasscode2() {
    ...
    if(code2 === "urebl") {
      chatWindow2.innerHTML += '<p>Ofmicheal: You have unlocked code 1:ur0</p>';
      scrollToBottom();
    }
    if(code2 === "11/14/1891") {
      chatWindow2.innerHTML += '<p>Ofmicheal: You have unlocked code 2:rr2</p>';
      scrollToBottom();
    }
    if(code2 === "B'nai Jehudah") {
      chatWindow2.innerHTML += '<p>Ofmicheal: You have unlocked code 3:209</p>';
      scrollToBottom();
    }
