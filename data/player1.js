...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function checkPasscode2() {
    ...
    if(code2 === "Breath of Renewal") {
      chatWindow2.innerHTML += '<p>Ofmicheal: You have unlocked code 1:95a</p>';
      scrollToBottom();
    }
    if(code2 === "10/04/2022") {
      chatWindow2.innerHTML += '<p>Ofmicheal: You have unlocked code 2:88x</p>';
      scrollToBottom();
    }
