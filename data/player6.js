...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function checkPasscode2() {
    ...
    if(code2 === "Leucobryum") {
      chatWindow2.innerHTML += '<p>Ofmicheal: You have unlocked code 1:1jh</p>';
      scrollToBottom();
    }
    if(code2 === "12/07/1986") {
      chatWindow2.innerHTML += '<p>Ofmicheal: You have unlocked code 2:26a</p>';
      scrollToBottom();
    }
    if(code2 === "GFL Environmental") {
      chatWindow2.innerHTML += '<p>Ofmicheal: You have unlocked code 3:ve4</p>';
      scrollToBottom();
    }
